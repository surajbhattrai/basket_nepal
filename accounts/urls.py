...
from .views import SignUpView, CustomerInfo, login_page ,change_password ,user_logout ,user_update,customer_verify ,resend , custom_password_reset ,reset_password_verify
...
urlpatterns = [
    ...
    path('customer/verify/',customer_verify,name='cverify'),
