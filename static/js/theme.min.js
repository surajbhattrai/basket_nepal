...
const HSBsDropdown = {
    ...
    openOnHover() {
      Array.from(document.querySelectorAll("[data-bs-open-on-hover]")).forEach(
        (t) => {
          var e;
          ...
          t.addEventListener("mouseenter", () => {
            ...
            Array.from([i._menu, t]).forEach((t) =>
  ...
  HSBsValidation = {
    ...
    onSubmit: (t) =>
      !(!t.options || "function" != typeof t.options.onSubmit) &&
      t.options.onSubmit(t),
  };
...
function mergeDeep(t, ...e) {
  ...
  if (isObject(t) && isObject(i))
    for (const e in i)
      isObject(i[e])
        ? (t[e] || Object.assign(t, { [e]: {} }), mergeDeep(t[e], i[e]))
...
(HSCore.components.HSMask = {
  ...
  init(t, e, i) {
    ...
    for (let t = 0; t < l.length; t += 1)
      o.addToCollection(l[t], e, i || l[t].id);
  ...
  _init() {
    ...
    for (let e = 0; e < t.collection.length; e += 1) {
      let i, o;
      t.collection[e].hasOwnProperty("$initializedEl") ||
   ...
   */ (HSCore.components.HSTomSelect = {
    ...
    _init() {
      ...
      for (let e = 0; e < t.collection.length; e += 1) {
        ...
        t.collection[e].hasOwnProperty("$initializedEl") ||
          ((i = t.collection[e].options),
          (o = t.collection[e].$el),
          i.plugins.hasOwnProperty("hs_smart_position") &&
            !o.closest(".modal") &&
            (i.dropdownParent = "body"),
          o.hasAttribute("multiple") &&
            (i.plugins = [...i.plugins, "remove_button"]),
              ...
              (this.$menu = this.dropdown_content.parentElement),
                this.on("dropdown_open", (t) => {
                  ...
                  e.bottom > window.innerHeight &&
                    (t.style.top =
                      ...
                      (this.control.clientHeight + t.clientHeight + 10) +
                      "px"),
                    (t.style.opacity = 0),
                    setTimeout(() => {
                ...
                window.addEventListener("scroll", () =>
                  (function (t) {
                    ...
                    e.bottom > window.innerHeight
                      ? (t.$menu.style.top =
                          parseInt(t.$menu.style.top) -
                          (t.control.clientHeight + t.$menu.clientHeight + 10) +
                          "px")
                      : e.top < 0 &&
                        (t.$menu.style.top =
                          parseInt(t.$menu.style.top) +
          ...
          i.singleMultiple &&
            t.singleMultiple(t.collection[e].$initializedEl, i),
          i.hidePlaceholderOnSearch &&
            t.hidePlaceholderOnSearch(t.collection[e].$initializedEl, i),
          i.create && t.openIfEmpty(t.collection[e].$initializedEl, i),
          i.hideSelectedFromField &&
            t.hideSelectedFromField(t.collection[e].$initializedEl, i),
    ...
    singleMultiple(t, e) {
      ...
      const i = (
          t.control_input.getAttribute("placeholder") || e.placeholder
        ).replace(/(<([^>]+)>)/gi, ""),
        o = (e) => {
          e.target.closest("[data-selectable].selected") &&
        ...
        l = (e) => {
          if (!t.wrapper.querySelector(".ts-selected-count")) {
            ...
            e.classList.add("ts-selected-count"),
              t.wrapper.querySelector(".items").appendChild(e);
          }
          return (t.wrapper.querySelector(".ts-selected-count").innerHTML = e);
        };
      t.items.length &&
        (e.searchInDropdown
          ? l(t.items.length ? t.items.length + " item(s) selected" : i)
          : t.control_input.setAttribute(
              "placeholder",
        ...
        t.on("item_add", () => {
          t.items.length &&
            (e.searchInDropdown
              ? l(t.items.length + " item(s) selected")
              : t.control_input.setAttribute(
                  "placeholder",
                  t.items.length + " item(s) selected"
                ));
      ...
      if (e.searchInDropdown && !e.hideSelected) {
        ...
        const o = function () {
            if (
              ...
              return (
                e.parentElement && e.parentElement.removeChild(e), (e = null)
              );
            t.items.length || e || l();
          },
          l = function () {
            t.items.length ||
              ((t.wrapper.querySelector(
                ".items"
              ).innerHTML = `<span class="ts-custom-placeholder">${i}</span>`),
              (e = t.wrapper.querySelector(".ts-custom-placeholder")));
          };
        l(), t.on("change", o);
      }
      i &&
        (t.control_input.offsetParent
          ? (function (e) {
              t.control_input.setAttribute(
                "placeholder",
                e.replace(/(<([^>]+)>)/gi, "")
          ...
          : (function (e) {
              ...
              i(),
                t.on("change", () => {
                  t.items.length &&
                    (() => {
                      const e = t.wrapper.querySelector(
                        ".items .ts-custom-placeholder"
                      );
    ...
    _init: function () {
      ...
      for (let e = 0; e < t.collection.length; e += 1) {
        ...
        t.collection[e].hasOwnProperty("$initializedEl") ||
          ...
          (t.collection[e].$initializedEl = new Typed(i, o)));
      }
    },
  }),
  /*
   ...
   */ (HSCore.components.HSNoUISlider = {
    ...
    _init() {
      ...
      for (let e = 0; e < t.collection.length; e += 1) {
        ...
        t.collection[e].hasOwnProperty("$initializedEl") ||
          ((i = t.collection[e].options),
          (o = t.collection[e].$el),
          (t.collection[e].$initializedEl = noUiSlider.create(o, i)),
          t.collection[e].$initializedEl.on("update", () => {
            t.updateMinField(t.collection[e].$initializedEl, i),
              t.updateMaxField(t.collection[e].$initializedEl, i),
              t.updateChart(t.collection[e].$initializedEl, i);
          }),
          i.showTooltips && t.showTooltips(t.collection[e].$initializedEl, i),
          i.result_min_target_el &&
            t.resultMinTargetEl(t.collection[e].$initializedEl, i),
          i.result_max_target_el &&
            t.resultMaxTargetEl(t.collection[e].$initializedEl, i));
      }
    },
    ...
    updateChart: function (t, e) {
      ...
      if (e.foreground_target_el && t.get().length <= 2) {
        ...
        (n.style.width = t.parentElement.clientWidth + "px"),
          (n.style.marginLeft =
            (-t.parentElement.clientWidth / 100) * i + "px");
      }
    },
    ...
    resultMinTargetEl: function (t, e) {
      document
        .querySelector(e.result_min_target_el)
    ...
    resultMaxTargetEl: function (t, e) {
      document
        .querySelector(e.result_max_target_el)
        .addEventListener("change", (e) => {
   ...
   */ (HSCore.components.HSCircles = {
    ...
    setTextStyles: function (t, e, i) {
      t.querySelectorAll(
        '[class="' + (e.textClass || i._textClass) + '"]'
      ).forEach((t) => {
      ...
      this.collection.push({
        ...
        options: Object.assign(
          {},
          {
            ...
            value: 0,
            text: function (t) {
              return "iconic" === o.type
                ? o.icon
                : "prefix" === o.additionalTextType
                ? o.secondaryText
                  ? (o.additionalText || "") +
                    (o.isHideValue ? "" : t) +
                    '<div style="margin-top: ' +
                    (o.dividerSpace / 2 + "px" || "0") +
                    "; margin-bottom: " +
                    (o.dividerSpace / 2 + "px" || "0") +
                    ';"></div><div style="font-weight: ' +
                    o.secondaryTextFontWeight +
                    "; font-size: " +
                    o.secondaryTextFontSize +
                    "px; color: " +
                    o.secondaryTextColor +
                    ';">' +
                    o.secondaryText +
                    "</div>"
                  : (o.additionalText || "") + (o.isHideValue ? "" : t)
                : o.secondaryText
                ? (o.isHideValue ? "" : t) +
                  (o.additionalText || "") +
                  '<div style="margin-top: ' +
                  ...
                  o.secondaryText +
                  "</div>"
                : (o.isHideValue ? "" : t) + (o.additionalText || "");
            },
          },
          o
        ),
    ...
    _init() {
      ...
      for (let e = 0; e < t.collection.length; e += 1) {
        ...
        t.collection[e].hasOwnProperty("$initializedEl") ||
          ...
          i.rtl && t.setRtl(o, i),
          i.fgStrokeLinecap &&
            t.setStrokeLineCap(o, i, t.collection[e].$initializedEl),
          i.fgStrokeMiterlimit &&
            t.setStrokeMiterLimit(o, i, t.collection[e].$initializedEl),
          i.isViewportInit &&
            t.initAppear(o, i, t.collection[e].$initializedEl));
      }
    },
  }),
  (HSCore.components.HSLeaflet = {
    init: function (t, e) {
      if (
        ...
        var i = this.$el.hasAttribute("data-hs-leaflet-options")
          ? JSON.parse(this.$el.getAttribute("data-hs-leaflet-options"))
          : {};
        this.settings = mergeDeep(this.defaults, { ...e, ...i });
        var o = L.map(this.$el, this.settings.map);
        if (
          (o.setView(this.settings.map.coords, this.settings.map.zoom),
          ...
          for (var l = 0; l < this.settings.marker.length; l++) {
            ...
            let t = L.marker(
              this.settings.marker[l].coords,
              this.settings.marker[l]
            ).addTo(o);
            this.settings.marker[l].popup &&
              t.bindPopup(this.settings.marker[l].popup.text);
          }
        return o;
      }
    },
  ...
  (HSCore.components.HSChartJS = {
    init: function (t, e) {
      if (
        ...
        var i = this.$el.hasAttribute("data-hs-chartjs-options")
          ? JSON.parse(this.$el.getAttribute("data-hs-chartjs-options"))
          : {};
        return (
                          ...
                          ticks: {
                            callback: function (t, e, i) {
                              var o =
                                ...
                                n =
                                  settings.options.scales.yAxes[0].ticks
                                    .postfix;
                              return (
                                o &&
                                  t > 100 &&
                                  (t =
                                    t < 1e6 ? t / 1e3 + "k" : t / 1e6 + "kk"),
                                l && n ? l + t + n : l ? l + t : n ? t + n : t
                              );
                            },
                          },
                        },
                  ...
                  custom: function (e) {
                    ...
                    if (
                      (i ||
                        ...
                        settings.options.tooltips.lineMode
                          ? (t.closest(".chartjs-custom").innerHTML = i)
                          : document.body.appendChild(i)),
                      0 === e.opacity)
                    )
                      return (
                        (i.style.opacity = 0), void i.parentNode.removeChild(i)
                      );
                    if (
                      (i.classList.remove("above", "below", "no-transform"),
                      e.yAlign
                        ? i.classList.add(e.yAlign)
                        : i.classList.add("no-transform"),
                      e.body)
                    ) {
                      var o = e.title || [],
                      ...
                      o.forEach(function (t) {
                        s += settings.options.tooltips.yearStamp
                          ? t + ", " + n.getFullYear()
                          : t;
                      }),
                        ...
                        l.forEach(function (t, i) {
                          ...
                          var o = t[0],
                            l = o,
                            n =
                              e.labelColors[i].backgroundColor instanceof Object
                                ? e.labelColors[i].borderColor
                                : e.labelColors[i].backgroundColor;
                          (s +=
                            (settings.options.tooltips.hasIndicator
                              ? '<span class="d-inline-block rounded-circle mr-1" style="width: ' +
                                settings.options.tooltips.indicatorWidth +
                                "; height: " +
                                settings.options.tooltips.indicatorHeight +
                                "; background-color: " +
                                n +
                                '"></span>'
                              : "") +
                            settings.options.tooltips.prefix +
                            (o.length > 3 ? l : t) +
                            settings.options.tooltips.postfix),
                            (s += "</div>");
                        }),
                        (s += "</div>"),
                    ...
                    (i.style.opacity = 1),
                      ...
                      (i.style.transition =
                        settings.options.tooltips.transition);
                  },
                },
              },
            },
  ...
  (HSCore.components.HSList = {
          ...
          s.preventDefault(),
            ...
            (a = i.list.querySelector(".active"))
              ? a.nextElementSibling &&
                ((r = a.nextElementSibling).classList.add("active"),
                n.classList.remove("active"),
                (n = r),
                i.list.offsetHeight < r.getBoundingClientRect().top &&
                  (i.list.scrollTop =
    ...
    searchMenu: function (t, e, i) {
      const o = this;
      if (
        0 === t.querySelector("." + i.searchClass).value.length ||
        (0 === i.visibleItems.length && !e.empty)
      )
        return (
          o.helpers.fadeOut(i.list, e.searchMenuDelay), o.helpers.hide(e.empty)
        );
      o.searchMenuShow(t, e, i);
    },
    searchMenuShow: function (t, e, i) {
      const o = this;
      if (
        (o.helpers.fadeIn(i.list, e.searchMenuDelay), !i.visibleItems.length)
      ) {
    ...
    searchMenuHide: function (t, e, i) {
      const o = this;
      var l = t.querySelector("." + i.searchClass);
      e.searchMenuOutsideClose &&
        document.addEventListener("click", () => {
          o.helpers.fadeOut(i.list, e.searchMenuDelay),
            e.clearSearchInput && (l.value = "");
        }),
        e.searchMenuInsideClose ||
          i.list.addEventListener("click", (t) => {
      ...
      fadeOut: (t, e) => {
        ...
        var i = setInterval(function () {
          t.style.opacity || (t.style.opacity = 1),
            t.style.opacity > 0
              ? (t.style.opacity -= 0.1)
              : (clearInterval(i), (t.style.display = "none"));
        }, e / 10);
      },
      hide: (t) => (
      ...
      for (let e = 0; e < t.collection.length; e += 1) {
        ...
        t.collection[e].hasOwnProperty("$initializedEl") ||
          ...
          t.collection[e].$initializedEl.on("searchComplete", () => {
            o.searchMenu &&
              (t.searchMenu(i, o, t.collection[e].$initializedEl),
              t.searchMenuHide(i, o, t.collection[e].$initializedEl)),
              !o.searchMenu &&
                o.empty &&
                t.emptyBlock(i, o, t.collection[e].$initializedEl);
          }),
          o.searchMenu &&
            o.keyboard &&
            t.initializeHover(i, o, t.collection[e].$initializedEl));
      }
    },
    getItem(t) {
      return "number" == typeof t
